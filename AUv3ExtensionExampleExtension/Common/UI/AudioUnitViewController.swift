...
public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    ...
    var hostingController: HostingController<AUv3ExtensionExampleExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        ...
        audioUnit.setupParameterTree(AUv3ExtensionExampleExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = AUv3ExtensionExampleExtensionMainView(parameterTree: observableParameterTree)
